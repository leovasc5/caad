...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/parceiros.css" type="text/css">
	<link href="../assets/img/favicon.ico" type="image/x-icon" rel="icon"/>
    <title>CADS - Parceiros</title>
</head>
<body>
...
<div class="container">
    <h1 class="container-titulo">Parceiros do CADS</h1>
    <div class="sub-container">
        <h2>Poxa!</h2>
        <h3>Ainda não temos parceiros.</h3>
        <p>Caso você queira se tornar nosso parceiro, entre em contato através do e-mail: <a href="mailto:cads@etec.sp.gov.br" target="_blank">cads@etec.sp.gov.br</a></p>
    </div>
</div>
